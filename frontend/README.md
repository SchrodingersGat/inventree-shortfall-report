# Component Shortfall- Frontend Code

This directory contains the frontend code for the Component Shortfall plugin.
...
This will compile the frontend into the `../component_shortfall/static` directory (ready for distribution).
